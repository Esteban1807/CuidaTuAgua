        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormModules_Forms_IdForm",
                        column: x => x.IdForm,
                        principalTable: "Forms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FormModules_Modules_IdModule",
                        column: x => x.IdModule,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataPeople_People_IdPerson",
                        column: x => x.IdPerson,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleFormPermissions_Forms_IdRole",
                        column: x => x.IdRole,
                        principalTable: "Forms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleFormPermissions_Permissions_IdRole",
                        column: x => x.IdRole,
                        principalTable: "Permissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleFormPermissions_Rols_IdRole",
                        column: x => x.IdRole,
                        principalTable: "Rols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRols_Rols_IdRole",
                        column: x => x.IdRole,
                        principalTable: "Rols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRols_Users_IdUser",
                        column: x => x.IdUser,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataPeople_IdPerson",
                table: "DataPeople",
                column: "IdPerson",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FormModules_IdForm",
                table: "FormModules",
                column: "IdForm");

            migrationBuilder.CreateIndex(
                name: "IX_FormModules_IdModule",
                table: "FormModules",
                column: "IdModule");

            migrationBuilder.CreateIndex(
                name: "IX_RoleFormPermissions_IdRole",
                table: "RoleFormPermissions",
                column: "IdRole");

            migrationBuilder.CreateIndex(
                name: "IX_UserRols_IdRole",
                table: "UserRols",
                column: "IdRole");

            migrationBuilder.CreateIndex(
                name: "IX_UserRols_IdUser",
                table: "UserRols",
                column: "IdUser");
